...
export default {
  ...
  methods:{
      ...
      getSwipeList(){
          //发送Ajax请求,http://localhost:8080/news/c?op=getSwipe
          Vue.axios.get("news/getSwipeNews").then((response)=>{
      ...
      onLoad(){
          ...
          Vue.axios.get("news/getPageNews?current="+this.pageNo).then((response)=>{
